...
class MesaageDialogBox extends Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Modal, {
      ...
      toggle: this.toggle.bind(this)
    }, this.props.headerContent) : "", /*#__PURE__*/React.createElement(ModalBody, null, this.props.content), this.props.buttons && this.props.buttons.length > 0 ? /*#__PURE__*/React.createElement(ModalFooter, null, this.props.buttons.map(item => {
      return /*#__PURE__*/React.createElement(Button, {
        color: "primary",
        id: item.id,
        name: item.title,
